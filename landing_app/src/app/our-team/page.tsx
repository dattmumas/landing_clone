    ...
    <div className="bg-white min-h-screen">
      ...
      >
        <div className="container mx-auto px-6">
          ...
          <p className="text-xl max-w-3xl" style={{ color: "#06d6a0" }}>
            Meet the founders behind Payce — combining financial expertise and
            technical innovation to revolutionize enterprise operations.
          </p>
        </div>
      </div>
